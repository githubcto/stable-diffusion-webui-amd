...
"""),
    ...
    "sd_vae_encode_method": OptionInfo("AMD", "VAE type for encode", gr.Radio, {"choices": ["Full", "TAESD", "AMD"]}, infotext='VAE Encoder').info("method to encode image to latent (use in img2img, hires-fix or inpaint mask)"),
    "sd_vae_decode_method": OptionInfo("AMD", "VAE type for decode", gr.Radio, {"choices": ["Full", "TAESD", "AMD"]}, infotext='VAE Decoder').info("method to decode latent to image"),
}))
